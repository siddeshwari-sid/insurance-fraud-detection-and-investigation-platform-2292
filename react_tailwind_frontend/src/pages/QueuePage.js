    ...
    >
      <div className="mb-4">
        <RetryState
          ...
          description="We couldn’t load the investigator queue from the backend."
        />
        {!rawError && !loading && claims.length === 0 && (
          <RetryState
            ...
            emptyDescription="No claims are currently available. Upload a CSV to ingest claims, then refresh."
          />
        )}
      </div>
